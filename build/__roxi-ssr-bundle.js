(() => {
  ...
  var require_jekyll_tutorial_71da4cb4 = __commonJS((exports) => {
    ...
    const main2 = __toModule(require_main());
    function x2(n3) {
      let a3, s3, t3, e3, p3, o3, l3, c3, i3, u3, b, x3, v2, f3, y, H, T, L, M, D, C, j, q, z, N, W, E, P, S, G, B, I, A, O, R, F, J, U, $2, K, Z, _, V, Y, Q, X, nn, an, sn, tn, en, pn, on, ln, cn, un, rn, kn, dn, gn, hn, mn, wn, bn, xn, vn, fn, yn, Hn, Tn, Ln, Mn, Dn, Cn, jn, qn, zn, Nn, Wn, En, Pn, Sn, Gn, Bn, In, An, On, Rn, Fn, Jn, Un, $n, Kn, Zn, _n, Vn, Yn, Qn, Xn, na, aa, sa, ta, ea, pa, oa, la, ca, ia, ua, ra, ka, da, ga, ha, ma, wa, ba, xa, va, fa, ya, Ha, Ta, La, Ma, Da, Ca, ja, qa, za, Na, Wa, Ea, Pa, Sa, Ga, Ba, Ia, Aa, Oa, Ra, Fa, Ja, Ua, $a, Ka, Za, _a, Va, Ya, Qa, Xa, ns, as, ss, ts, es, ps, os, ls, cs, is, us, rs, ks, ds, gs, hs;
      return {c() {
        a3 = main2.e("p"), a3.textContent = "Moin \u{1F44B},", s3 = main2.a(), t3 = main2.e("p"), t3.innerHTML = 'in diesem Blogpost soll es um den Bau einer einfachen Website mit Jekyll und das kostenlose Hosten dieser Seite mit <code class="dark:text-white">GitHub-Pages</code>.', e3 = main2.a(), p3 = main2.e("h3"), p3.textContent = "Vorrausetzungen", o3 = main2.a(), l3 = main2.e("p"), l3.innerHTML = 'Wenn du diesem Tutorial folgen willst, dannn gehe bitte sicher, dass du schon HTML beherrschst, da ich hier nicht alles dar\xFCber erkl\xE4ren kann. Falls du noch nicht HTML beherrschst, ist dieses Tutorial empfehlenswert: <a class="dark:text-white" href="https://www.youtube.com/watch?v=qmTNnZCDJY0">Eigene Website mit HTML und CSS bauen</a>', c3 = main2.a(), i3 = main2.e("p"), i3.textContent = "Zudem erf\xFClle bitte folgende Vorraussetzungen:", u3 = main2.a(), b = main2.e("ul"), b.innerHTML = '<li>habe auf deinem PC einen Codeeditor installiert, ich pers\xF6nlich nutze VS Code, <a class="dark:text-white" href="https://code.visualstudio.com/">hier</a> downloadbar (man kann zwar reintheoretisch auch den Standard Windowseditor benutzen was allerdings etwas umst\xE4ndlich ist)</li> \n<li>installiere <a class="dark:text-white" href="https://git-scm.com/">Git</a> und <a class="dark:text-white" href="https://www.ruby-lang.org/de/downloads/">Ruby</a> auf deinem PC \u{1F5A5}</li> \n<li>nachdem du Ruby installiert hast, f\xFChre <code class="dark:text-white">gem install bundler jekyll</code> in deinem Terminal aus</li>', x3 = main2.a(), v2 = main2.e("p"), v2.textContent = "Du erf\xFCllst alle Vorrausetzungen? Dann lass uns direkt starten \u{1F680}", f3 = main2.a(), y = main2.e("h2"), y.textContent = "Erstellen eines neuen Projektes", H = main2.a(), T = main2.e("p"), T.textContent = "Um mit dem Programmieren zu beginnen, navigiere zun\xE4chst in einem Terminal in den Ordner, in dem du das Projekt erstellen m\xF6chtest. Dorthin navigiert, f\xFChre in deinem Terminal zum erstellen des Projektes den Befehl", L = main2.a(), M = main2.e("pre"), D = main2.a(), C = main2.e("p"), C.textContent = "aus. Damit wird dein Projekt erstellt.", j = main2.a(), q = main2.e("p"), q.textContent = "Navigiere nun in den Projekordner mit", z = main2.a(), N = main2.e("pre"), W = main2.a(), E = main2.e("p"), E.textContent = "und f\xFChre den Befehl", P = main2.a(), S = main2.e("pre"), G = main2.a(), B = main2.e("p"), B.innerHTML = 'aus. Wenn du nun in deinem Webbrowser <a class="dark:text-white" href="localhost:4000">localhost:4000</a> eingibst, kannst du die Standardseite, die von Jekyll automatisch generiert wurde, sehen.', I = main2.a(), A = main2.e("h2"), A.textContent = "Eigene Inhalte erstellen", O = main2.a(), R = main2.e("p"), R.innerHTML = 'Nun wollen wir aber nicht die Jekyll-Defaultwebsite, sondern eine eigene Website entwickeln. Dazu stoppen wir zun\xE4chst den Server und l\xF6schen dann alles bis auf die Dateien <code class="dark:text-white">_config.yml</code>, <code class="dark:text-white">Gemfile</code>, <code class="dark:text-white">Gemfile.lock</code>, <code class="dark:text-white">.gitignore</code> und <code class="dark:text-white">404.html</code>.', F = main2.a(), J = main2.e("p"), J.innerHTML = 'Daraufhin ersetzen wir den Inhalt der Datei <code class="dark:text-white">_config.yml</code> durch folgendes:', U = main2.a(), $2 = main2.e("pre"), K = main2.a(), Z = main2.e("p"), Z.innerHTML = 'Dann erstellen wir eine Datei mit dem Namen <code class="dark:text-white">index.html</code>, die folgenderma\xDFen aussieht:', _ = main2.a(), V = main2.e("pre"), Y = main2.a(), Q = main2.e("br"), X = main2.t("\nWenn wir nun mit "), nn = main2.e("code"), nn.textContent = "bundle exec jekyll serve", an = main2.t(" die Seite neu starten, bekommen wir folgendes zu sehen:\n"), sn = main2.e("img"), en = main2.a(), pn = main2.e("p"), pn.innerHTML = 'Das vorher programmierte <code class="dark:text-white">Hallo Welt</code> erscheint! Wenn wir das hier geschafft haben k\xF6nnen wir die Seite nach unseren W\xFCnschen und Bed\xFCrfnissen mit <code class="dark:text-white">HTML</code> ; <code class="dark:text-white">CSS</code> und <code class="dark:text-white">JavaScript</code> gestalten.', on = main2.a(), ln = main2.e("h2"), ln.textContent = "Layouts und Includes in Jekyll \u{1F503}", cn = main2.t("\nBisher haben wir ein einfaches "), un = main2.e("code"), un.textContent = "Hallo Welt", rn = main2.t(" auf der Website erscheinen lassen. Dies sah 1. nicht sch\xF6n aus und zweitens ist eine richtige Website ja auch etwas anderes...\n"), kn = main2.e("p"), kn.textContent = "Meistens sind Websites ja so aufgebaut:", dn = main2.a(), gn = main2.e("ul"), gn.innerHTML = "<li>oben: Navigationsleiste</li> \n<li>mitte: Inhalt</li> \n<li>unten: Fu\xDFzeile/Footer mit \xA9 und Link zu Impressum</li>", hn = main2.a(), mn = main2.e("p"), mn.innerHTML = 'Wenn unsere Website mehrere Seiten beinhaltet, dann m\xFCssten wir rein theoretisch die Navigation und den Footer in jeder <code class="dark:text-white">HTML</code> Datei neu schreiben, was nat\xFCrlich umst\xE4ndlich ist und bei \xC4nderungen and diesen Komponenten schnell un\xFCbersichtlich wird, da wir die Komponente in jeder Datei dann \xE4ndern m\xFCssen.\nDoch Jekyll nimmt uns diese Arbeit mit den sogenannten <code class="dark:text-white">Includes</code> und <code class="dark:text-white">Layouts</code> ab:', wn = main2.a(), bn = main2.e("h3"), bn.textContent = "Includes", xn = main2.t("\nStatt in jeder Datei z.B. deie Naviation neu zu programmieren, k\xF6nnen wir die Navbar in "), vn = main2.e("b"), vn.textContent = "einer", fn = main2.t(" Datei designen und m\xFCsssen diese dann lediglich in den anderen "), yn = main2.e("code"), yn.textContent = "HTML", Hn = main2.t(" Dateien importieren. Der Vorteil liegt auf der Hand: Wir \xE4ndern die auf jeder Seite vorhandene Komponente wie die Navigationsbar nur in einer Datei und m\xFCssen nicht in jeder Datei diese neu programmieren. Und so gehen wir dabei vor:\n"), Tn = main2.e("ol"), Tn.innerHTML = '<li>Wir erstellen einen Ordner mit dem Namen <code class="dark:text-white">_includes</code>. Dies ist wichtig, da Jekyll nur aus einem Ordner mit <b>exakt</b> diesem Namen importieren kann</li> \n<li>Erstelle eine Datei mit dem Namen <code class="dark:text-white">_navbar.html</code> in dem in 1. erstellten Ordner, hier werden wir die Navigationsleiste unserer Seite erstellen.</li> \n<li>Bearbeite nun deine <code class="dark:text-white">index.html</code> so, dass sie folgenderma\xDFen aussieht:</li>', Ln = main2.a(), Mn = main2.e("pre"), Dn = main2.a(), Cn = main2.e("p"), Cn.innerHTML = 'Damit importierst du <a href="https://bulma.io/" class="dark:text-white">Bulma</a>, ein <code class="dark:text-white">CSS</code> Framework, das ich hier nutze, da es vorgefertigte Komponenten wie Navbars bereitstellt (das macht die Arbeit am Anfang deutlich leichter). Zudem definiertst du mit <code class="dark:text-white">permalink: /</code> den Link, mit dem <code class="dark:text-white">index.html</code> aufgerufen wird.', jn = main2.a(), qn = main2.e("ol"), qn.innerHTML = '<li>Nun programmieren wir die Navbar: dazu begeben wir uns zur\xFCck in die Datei <code class="dark:text-white">_navbar.html</code> und programmieren folgendes als Navbar:</li>', zn = main2.a(), Nn = main2.e("pre"), Wn = main2.a(), En = main2.e("p"), En.innerHTML = 'Du kannst auch deine eigene Navbar entwickeln, die (in englisch verfasste) Dokumentation dazu findest du <a href="https://bulma.io/documentation/components/navbar/" class="dark:text-white">hier</a>.', Pn = main2.a(), Sn = main2.e("ol"), Sn.innerHTML = '<li>Nun wollen wir die Navbar in unser <code class="dark:text-white">index.html</code> Datei importieren: Dazu \xF6ffnen wir <code class="dark:text-white">index.html</code> und f\xFCgen \xFCber</li>', Gn = main2.a(), Bn = main2.e("pre"), In = main2.a(), An = main2.e("p"), An.textContent = "die Zeile", On = main2.a(), Rn = main2.e("pre"), Fn = main2.a(), Jn = main2.e("p"), Jn.textContent = "hinzu, die dann die Navbar importiert. Wenn wir uns nun im Browser unsere Seite neu laden k\xF6nnen wir in etwa folgendes sehen:", Un = main2.a(), $n = main2.e("img"), Zn = main2.a(), _n = main2.e("p"), _n.textContent = "Zu sehen ist die von uns programmierte Navigationsleiste\u{1F973}", Vn = main2.a(), Yn = main2.e("p"), Yn.textContent = "Nun kommen wir zur ersten Aufgabe f\xFCr dich:", Qn = main2.a(), Xn = main2.e("p"), Xn.innerHTML = 'Programmiere f\xFCr die Website einen Footer(= Fu\xDFzeile) und importiere diesen mithilfe von <code class="dark:text-white">Includes</code> in die Datei <code class="dark:text-white">index.html</code>. Die Footer Komponente von <code class="dark:text-white">Bulma</code> kannst du <a class="dark:text-white" href="https://bulma.io/documentation/layout/footer/">hier</a> finden. Du kannst aber gerne auch einen eigenen Footer entwickeln.', na = main2.a(), aa = main2.e("h3"), aa.textContent = "Layouts", sa = main2.a(), ta = main2.e("code"), ta.textContent = "Layouts", ea = main2.t(" sind gewisserma\xDFen der Bruder der "), pa = main2.e("code"), pa.textContent = "Includes", oa = main2.t(", sie sind n\xE4mlich nicht nur wie die "), la = main2.e("code"), la.textContent = "Includes", ca = main2.t(" eine Blaupause f\xFCr eine Komponente der Seite, sondern eine Blaupause f\xFCr die gesamte Seite (das Layout). Das tolle an "), ia = main2.e("code"), ia.textContent = "Layouts", ua = main2.t(" ist, dass diese nicht nur f\xFCr "), ra = main2.e("code"), ra.textContent = "HTML", ka = main2.t(" Dateien funktionieren, sondern auch f\xFCr "), da = main2.e("code"), da.textContent = "Markdown", ga = main2.t(" verarbeiten k\xF6nnen.\n"), ha = main2.e("p"), ha.innerHTML = 'Um eigene <code class="dark:text-white">Layouts</code> zu erstellen, m\xFCssen wir zun\xE4chst neben <code class="dark:text-white">_includes</code> einen Ordner mit dem Namen <code class="dark:text-white">_layouts</code> erstellen; in diesem Ordner werden wir unsere Layouts speichern.', ma = main2.a(), wa = main2.e("p"), wa.innerHTML = 'In dem gerade erstellten Ordner erstellen wir nun unser erstes Layout, indem wir eine Datei mit dem Namen <code class="dark:text-white">default.html</code> erstellen.\nDanach d\xFCrfte die Ordnerstruktur unseres Projektes so aussehen:', ba = main2.a(), xa = main2.e("img"), fa = main2.a(), ya = main2.e("p"), ya.innerHTML = 'Zun\xE4chst kopieren wir den gesamten Code unserer <code class="dark:text-white">index.html</code> in <code class="dark:text-white">default.html</code>.', Ha = main2.a(), Ta = main2.e("p"), Ta.innerHTML = 'Daraufhin bearbeiten wir die Datei <code class="dark:text-white">default.html</code> so, dass sie folgenderma\xDFen aussieht:', La = main2.a(), Ma = main2.e("pre"), Da = main2.a(), Ca = main2.e("p"), Ca.innerHTML = 'Nun bearbeiten wir die Datei <code class="dark:text-white">index.html</code> folgenderma\xDFen:', ja = main2.a(), qa = main2.e("pre"), za = main2.a(), Na = main2.e("p"), Na.textContent = "Wenn wir uns nun unsere Ausgabe im Browser anschauen, k\xF6nnen wir folgendes sehen:", Wa = main2.a(), Ea = main2.e("img"), Sa = main2.a(), Ga = main2.e("p"), Ga.textContent = "Doch was genau haben wir hier gemacht?", Ba = main2.a(), Ia = main2.e("p"), Ia.innerHTML = 'Wir haben zun\xE4chst in <code class="dark:text-white">default.html</code> ein Layout entwickelt, dass', Aa = main2.a(), Oa = main2.e("ol"), Oa.innerHTML = '<li>Die Navbar per <code class="dark:text-white">include</code> importiert (wenn du einen eigenen Footer entwickelt hast, solltest du diesen nat\xFCrlich auch includen \u{1F609})</li> \n<li>einen Ort definiert wo der Parameter <code class="dark:text-white">title</code>, also der Titel der jeweiligen Seite angezeigt wird; in diesem Falle ist dies logischerweise ein <code class="dark:text-white">h1</code> Tag</li> \n<li>haben wir die Stelle definiert, an der der Inhalt (==<code class="dark:text-white">content</code>) unserer Seite steht</li> \n<li>haben wir in dem Header von <code class="dark:text-white">index.html</code> den <code class="dark:text-white">title</code> sowie das <code class="dark:text-white">layout</code> definiert</li> \n<li>haben wir in der <code class="dark:text-white">index.html</code> in dem <code class="dark:text-white"><div></div></code> mit der Klasse <code class="dark:text-white">content</code> (die wir im Layout definiert haben) unsere Inhalte erstellt.</li>', Ra = main2.a(), Fa = main2.e("b"), Fa.textContent = "Aufgabe", Ja = main2.t(": Erstelle nun das Impressum\n"), Ua = main2.e("p"), Ua.innerHTML = "<em>Tips:</em>", $a = main2.a(), Ka = main2.e("ul"), Ka.innerHTML = '<li>Da wir in der Navbar schon als Link f\xFCr das Impressum /impressum/ angeben haben, ist es naheliegend, dies auch als Permalink zu nutzen</li> \n<li>erstelle deine <code class="dark:text-white">HTML</code> Datei f\xFCr das Impressum im gleichen Ordner \u{1F4C1} wie <code class="dark:text-white">index.html</code></li>', Za = main2.a(), _a = main2.e("h2"), _a.textContent = "Kostenloses Hosting mit GitHub-Pages\u{1F525}", Va = main2.a(), Ya = main2.e("h3"), Ya.textContent = "\u{1F6A7} Wichtig! Lese diesen Abschnitt erst ganz genau durch, bevor du den beschriebenen Vorgang durchf\xFChrst!\u{1F6A7}", Qa = main2.a(), Xa = main2.e("p"), Xa.innerHTML = 'Wenn du nun (hoffentlich mit der Hilfe dieses Tutorials\u{1F643}) eine eigene Website mit <code class="dark:text-white">Jekyll</code> entwickelt hast und diese ver\xF6ffentlichen m\xF6chtest, bietet sich <code class="dark:text-white">GitHub-Pages</code> als besonders elegante und kostenlose\u{1F4B5} L\xF6sung an. Eigentlich ist <code class="dark:text-white">Github</code> eine Website zum Teilen von Open-Source Code, allerdings gibt es inzwischen tausende Features mehr. Eines dieser vielen Features ist das kostenlose Hosten von Jekyll-Webpages. Die einzige Vorraussetzung ist: besitze einen kostenlosen <a href="https://github.com/" class="dark:text-white">GitHub-Account</a>. Falls du noch keinen GitHub Account hast, aber dir einen speziell f\xFCr <code class="dark:text-white">GitHub-Pages</code> erstellen willst, folgender Hinweis: Die Website bekommt standardm\xE4\xDFig <b>immer</b> folgende URL: <code class="dark:text-white">BENUTZERNAME.github.io</code>, wobei <code class="dark:text-white">BENUTZERNAME</code> dein GitHub Username ist. Man kann das zwar auch auf andere Domains \u201Cumprogrammieren\u201D, dies verursacht allerdings Extraaufwand und kann auch Kosten hervorrufen (vor allem bei dem eigenen Domainnamen, denn der muss in der Regel gekauf werden). Aus diesen Gr\xFCnden sei geraten, sich einen guten GitHub-Username auszusuchen, da dieser Bestandteil der URL ist!', ns = main2.a(), as = main2.e("p"), as.textContent = "Hast du deinen GitHub Account erstellt, kannst du auch schon direkt loslegen:", ss = main2.a(), ts = main2.e("p"), ts.innerHTML = 'Erstelle zun\xE4chst unter <a href="https://github.com/new" class="dark:text-white" target="_blank" rel="noopener">https://github.com/new</a> ein neues GitHub-Repository mit dem Namen <code class="dark:text-white">BENUTZERNAME.github.io</code>, wobei <code class="dark:text-white">BENUTZERNAME</code> dein <b>exakter</b> GitHub Benutzername sein muss!', es = main2.a(), ps = main2.e("p"), ps.textContent = "W\xE4hle dann folgende Optionen aus:", os = main2.a(), ls = main2.e("img"), is = main2.a(), us = main2.e("p"), us.innerHTML = 'Wenn du fertig bist, klicke auf <code class="dark:text-white">Create Repository</code> und erstelle damit das Repository. Nun solltest du in etwa folgendes zu Gesicht bekommen:', rs = main2.a(), ks = main2.e("img"), gs = main2.a(), hs = main2.e("p"), hs.innerHTML = 'Jetzt musst du nur noch auf <code class="dark:text-white">uploading an existing file</code> klicken. Dort gelangst du dann zu einer \xDCbersicht, wo du deine Projektdateien uploaden kannst. Diese werden dann von <code class="dark:text-white">GitHub Pages</code> automatisch zum hosten genutzt. Du kannst auch in Zukunft die Dateien auf GitHub ver\xE4ndern, l\xF6schen und neue Dateien erstellen. All dieser Vorg\xE4nge werden von <code class="dark:text-white">GitHub Pages</code> automatisch verarbeitet.', main2.b(p3, "class", "dark:text-white"), main2.b(y, "class", "dark:text-white"), main2.b(M, "class", "language-bash"), main2.b(N, "class", "language-bash"), main2.b(S, "class", "language-bash"), main2.b(A, "class", "dark:text-white"), main2.b($2, "class", "language-yml"), main2.b(V, "class", "language-html"), main2.b(nn, "class", "dark:text-white"), main2.b(sn, "alt", "Result Screenshot no. 1"), sn.src !== (tn = "/images/jekyll-tutorial/screenshot1.jpg") && main2.b(sn, "src", "/images/jekyll-tutorial/screenshot1.jpg"), main2.b(ln, "class", "dark:text-white"), main2.b(un, "class", "dark:text-white"), main2.b(bn, "class", "dark:text-white"), main2.b(yn, "class", "dark:text-white"), main2.b(Mn, "class", "language-html"), main2.b(qn, "start", "4"), main2.b(Nn, "class", "language-html"), main2.b(Sn, "start", "5"), main2.b(Bn, "class", "language-html"), main2.b(Rn, "class", "language-css"), main2.b($n, "alt", "Result Screenshot no. 2"), $n.src !== (Kn = "/images/jekyll-tutorial/screenshot2.jpg") && main2.b($n, "src", "/images/jekyll-tutorial/screenshot2.jpg"), main2.b(aa, "class", "dark:text-white"), main2.b(ta, "class", "dark:text-white"), main2.b(pa, "class", "dark:text-white"), main2.b(la, "class", "dark:text-white"), main2.b(ia, "class", "dark:text-white"), main2.b(ra, "class", "dark:text-white"), main2.b(da, "class", "dark:text-white"), main2.b(xa, "alt", "Ordnerstruktur des Projektes"), xa.src !== (va = "/images/jekyll-tutorial/screenshot3.jpg") && main2.b(xa, "src", "/images/jekyll-tutorial/screenshot3.jpg"), main2.b(Ma, "class", "language-html"), main2.b(qa, "class", "language-html"), main2.b(Ea, "alt", "Result Screenshot no. 4"), Ea.src !== (Pa = "/images/jekyll-tutorial/screenshot4.jpg") && main2.b(Ea, "src", "/images/jekyll-tutorial/screenshot4.jpg"), main2.b(_a, "class", "dark:text-white"), main2.b(Ya, "class", "dark:text-white"), main2.b(ls, "alt", "Creating a new GitHub repository"), ls.src !== (cs = "/images/jekyll-tutorial/screenshot5.jpg") && main2.b(ls, "src", "/images/jekyll-tutorial/screenshot5.jpg"), main2.b(ks, "alt", "GitHub Repository"), ks.src !== (ds = "/images/jekyll-tutorial/screenshot6.jpg") && main2.b(ks, "src", "/images/jekyll-tutorial/screenshot6.jpg");
      }, m(n4, r3) {
        main2.c(n4, a3, r3), main2.c(n4, s3, r3), main2.c(n4, t3, r3), main2.c(n4, e3, r3), main2.c(n4, p3, r3), main2.c(n4, o3, r3), main2.c(n4, l3, r3), main2.c(n4, c3, r3), main2.c(n4, i3, r3), main2.c(n4, u3, r3), main2.c(n4, b, r3), main2.c(n4, x3, r3), main2.c(n4, v2, r3), main2.c(n4, f3, r3), main2.c(n4, y, r3), main2.c(n4, H, r3), main2.c(n4, T, r3), main2.c(n4, L, r3), main2.c(n4, M, r3), M.innerHTML = '<code class="language-bash">jekyll new PROJEKTNAME</code>', main2.c(n4, D, r3), main2.c(n4, C, r3), main2.c(n4, j, r3), main2.c(n4, q, r3), main2.c(n4, z, r3), main2.c(n4, N, r3), N.innerHTML = '<code class="language-bash"><span class="token builtin class-name">cd</span> PROJEKTNAME</code>', main2.c(n4, W, r3), main2.c(n4, E, r3), main2.c(n4, P, r3), main2.c(n4, S, r3), S.innerHTML = '<code class="language-bash">bundle <span class="token builtin class-name">exec</span> jekyll serve</code>', main2.c(n4, G, r3), main2.c(n4, B, r3), main2.c(n4, I, r3), main2.c(n4, A, r3), main2.c(n4, O, r3), main2.c(n4, R, r3), main2.c(n4, F, r3), main2.c(n4, J, r3), main2.c(n4, U, r3), main2.c(n4, $2, r3), $2.innerHTML = '<code class="language-yml"><span class="token key atrule">title</span><span class="token punctuation">:</span> Your awesome title\n<span class="token key atrule">baseurl</span><span class="token punctuation">:</span> <span class="token string">""</span>\n<span class="token key atrule">url</span><span class="token punctuation">:</span> <span class="token string">""</span>\n\n<span class="token key atrule">plugins</span><span class="token punctuation">:</span>\n  <span class="token punctuation">-</span> jekyll<span class="token punctuation">-</span>feed</code>', main2.c(n4, K, r3), main2.c(n4, Z, r3), main2.c(n4, _, r3), main2.c(n4, V, r3), V.innerHTML = '<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>de<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>viewport<span class="token punctuation">"</span></span> <span class="token attr-name">content</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>width=device-width, initial-scale=1.0<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>title</span><span class="token punctuation">></span></span>Hallo Jekyll<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>title</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>head</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span><span class="token punctuation">></span></span>Hallo Welt<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span></code>', main2.c(n4, Y, r3), main2.c(n4, Q, r3), main2.c(n4, X, r3), main2.c(n4, nn, r3), main2.c(n4, an, r3), main2.c(n4, sn, r3), main2.c(n4, en, r3), main2.c(n4, pn, r3), main2.c(n4, on, r3), main2.c(n4, ln, r3), main2.c(n4, cn, r3), main2.c(n4, un, r3), main2.c(n4, rn, r3), main2.c(n4, kn, r3), main2.c(n4, dn, r3), main2.c(n4, gn, r3), main2.c(n4, hn, r3), main2.c(n4, mn, r3), main2.c(n4, wn, r3), main2.c(n4, bn, r3), main2.c(n4, xn, r3), main2.c(n4, vn, r3), main2.c(n4, fn, r3), main2.c(n4, yn, r3), main2.c(n4, Hn, r3), main2.c(n4, Tn, r3), main2.c(n4, Ln, r3), main2.c(n4, Mn, r3), Mn.innerHTML = '<code class="language-html">---\npermalink: /\n---\n\n<span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>de<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>viewport<span class="token punctuation">"</span></span> <span class="token attr-name">content</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>width=device-width, initial-scale=1.0<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span>\n      <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>stylesheet<span class="token punctuation">"</span></span>\n      <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>https://cdn.jsdelivr.net/npm/bulma@0.9.0/css/bulma.min.css<span class="token punctuation">"</span></span>\n    <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>title</span><span class="token punctuation">></span></span>Your awesome title<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>title</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>head</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>section</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>section<span class="token punctuation">"</span></span> <span class="token style-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token style language-css"><span class="token property">margin-top</span><span class="token punctuation">:</span> 0.2rem<span class="token punctuation">;</span> <span class="token property">margin-bottom</span><span class="token punctuation">:</span> 1.5rem<span class="token punctuation">;</span></span><span class="token punctuation">"</span></span></span><span class="token punctuation">></span></span>\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>container<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>section</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span> <span class="token punctuation">/></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span></code>', main2.c(n4, Dn, r3), main2.c(n4, Cn, r3), main2.c(n4, jn, r3), main2.c(n4, qn, r3), main2.c(n4, zn, r3), main2.c(n4, Nn, r3), Nn.innerHTML = '<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>nav</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar is-light<span class="token punctuation">"</span></span> <span class="token attr-name">role</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navigation<span class="token punctuation">"</span></span> <span class="token attr-name">aria-label</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>main navigation<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-brand<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-item<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n      Titel\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>\n\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span>\n        <span class="token attr-name">role</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>button<span class="token punctuation">"</span></span>\n        <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-burger burger<span class="token punctuation">"</span></span>\n        <span class="token attr-name">aria-label</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>menu<span class="token punctuation">"</span></span>\n        <span class="token attr-name">aria-expanded</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>false<span class="token punctuation">"</span></span>\n        <span class="token attr-name">data-target</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbarBasicExample<span class="token punctuation">"</span></span>\n      <span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span> <span class="token attr-name">aria-hidden</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>true<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span> <span class="token attr-name">aria-hidden</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>true<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span> <span class="token attr-name">aria-hidden</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>true<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">></span></span>\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbarBasicExample<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-menu<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-start<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-item<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n          Home\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-end<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n          <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navbar-item<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/impressum/<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n            Impressum\n          <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>nav</span><span class="token punctuation">></span></span></code>', main2.c(n4, Wn, r3), main2.c(n4, En, r3), main2.c(n4, Pn, r3), main2.c(n4, Sn, r3), main2.c(n4, Gn, r3), main2.c(n4, Bn, r3), Bn.innerHTML = '<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>section</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>section<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>section</span><span class="token punctuation">></span></span></code>', main2.c(n4, In, r3), main2.c(n4, An, r3), main2.c(n4, On, r3), main2.c(n4, Rn, r3), Rn.innerHTML = '<code class="language-css"><span class="token punctuation">&#123;</span>% include _navbar.html %<span class="token punctuation">&#125;</span></code>', main2.c(n4, Fn, r3), main2.c(n4, Jn, r3), main2.c(n4, Un, r3), main2.c(n4, $n, r3), main2.c(n4, Zn, r3), main2.c(n4, _n, r3), main2.c(n4, Vn, r3), main2.c(n4, Yn, r3), main2.c(n4, Qn, r3), main2.c(n4, Xn, r3), main2.c(n4, na, r3), main2.c(n4, aa, r3), main2.c(n4, sa, r3), main2.c(n4, ta, r3), main2.c(n4, ea, r3), main2.c(n4, pa, r3), main2.c(n4, oa, r3), main2.c(n4, la, r3), main2.c(n4, ca, r3), main2.c(n4, ia, r3), main2.c(n4, ua, r3), main2.c(n4, ra, r3), main2.c(n4, ka, r3), main2.c(n4, da, r3), main2.c(n4, ga, r3), main2.c(n4, ha, r3), main2.c(n4, ma, r3), main2.c(n4, wa, r3), main2.c(n4, ba, r3), main2.c(n4, xa, r3), main2.c(n4, fa, r3), main2.c(n4, ya, r3), main2.c(n4, Ha, r3), main2.c(n4, Ta, r3), main2.c(n4, La, r3), main2.c(n4, Ma, r3), Ma.innerHTML = '<code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>de<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>viewport<span class="token punctuation">"</span></span> <span class="token attr-name">content</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>width=device-width, initial-scale=1.0<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span>\n      <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>stylesheet<span class="token punctuation">"</span></span>\n      <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>https://cdn.jsdelivr.net/npm/bulma@0.9.0/css/bulma.min.css<span class="token punctuation">"</span></span>\n    <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>title</span><span class="token punctuation">></span></span>Your awesome title<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>title</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>head</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>\n    &#123;% include _navbar.html %&#125;\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>section</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>section<span class="token punctuation">"</span></span> <span class="token style-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token style language-css"><span class="token property">margin-top</span><span class="token punctuation">:</span> 0.2rem<span class="token punctuation">;</span> <span class="token property">margin-bottom</span><span class="token punctuation">:</span> 1.5rem<span class="token punctuation">;</span></span><span class="token punctuation">"</span></span></span><span class="token punctuation">></span></span>\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>container content<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>title<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>&#123;&#123;page.title&#125;&#125;<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">></span></span>\n        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span> <span class="token punctuation">/></span></span>\n        &#123;&#123;content&#125;&#125;\n      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>section</span><span class="token punctuation">></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span> <span class="token punctuation">/></span></span>\n    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span> <span class="token punctuation">/></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>\n&lt;/ht</code>', main2.c(n4, Da, r3), main2.c(n4, Ca, r3), main2.c(n4, ja, r3), main2.c(n4, qa, r3), qa.innerHTML = '<code class="language-html">---\npermalink: /\nlayout: default\ntitle: Home\n---\n\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>content<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Hier steht der Inhalt der Indexseite...<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>', main2.c(n4, za, r3), main2.c(n4, Na, r3), main2.c(n4, Wa, r3), main2.c(n4, Ea, r3), main2.c(n4, Sa, r3), main2.c(n4, Ga, r3), main2.c(n4, Ba, r3), main2.c(n4, Ia, r3), main2.c(n4, Aa, r3), main2.c(n4, Oa, r3), main2.c(n4, Ra, r3), main2.c(n4, Fa, r3), main2.c(n4, Ja, r3), main2.c(n4, Ua, r3), main2.c(n4, $a, r3), main2.c(n4, Ka, r3), main2.c(n4, Za, r3), main2.c(n4, _a, r3), main2.c(n4, Va, r3), main2.c(n4, Ya, r3), main2.c(n4, Qa, r3), main2.c(n4, Xa, r3), main2.c(n4, ns, r3), main2.c(n4, as, r3), main2.c(n4, ss, r3), main2.c(n4, ts, r3), main2.c(n4, es, r3), main2.c(n4, ps, r3), main2.c(n4, os, r3), main2.c(n4, ls, r3), main2.c(n4, is, r3), main2.c(n4, us, r3), main2.c(n4, rs, r3), main2.c(n4, ks, r3), main2.c(n4, gs, r3), main2.c(n4, hs, r3);
      }, p: main2.n, d(n4) {
        n4 && main2.f(a3), n4 && main2.f(s3), n4 && main2.f(t3), n4 && main2.f(e3), n4 && main2.f(p3), n4 && main2.f(o3), n4 && main2.f(l3), n4 && main2.f(c3), n4 && main2.f(i3), n4 && main2.f(u3), n4 && main2.f(b), n4 && main2.f(x3), n4 && main2.f(v2), n4 && main2.f(f3), n4 && main2.f(y), n4 && main2.f(H), n4 && main2.f(T), n4 && main2.f(L), n4 && main2.f(M), n4 && main2.f(D), n4 && main2.f(C), n4 && main2.f(j), n4 && main2.f(q), n4 && main2.f(z), n4 && main2.f(N), n4 && main2.f(W), n4 && main2.f(E), n4 && main2.f(P), n4 && main2.f(S), n4 && main2.f(G), n4 && main2.f(B), n4 && main2.f(I), n4 && main2.f(A), n4 && main2.f(O), n4 && main2.f(R), n4 && main2.f(F), n4 && main2.f(J), n4 && main2.f(U), n4 && main2.f($2), n4 && main2.f(K), n4 && main2.f(Z), n4 && main2.f(_), n4 && main2.f(V), n4 && main2.f(Y), n4 && main2.f(Q), n4 && main2.f(X), n4 && main2.f(nn), n4 && main2.f(an), n4 && main2.f(sn), n4 && main2.f(en), n4 && main2.f(pn), n4 && main2.f(on), n4 && main2.f(ln), n4 && main2.f(cn), n4 && main2.f(un), n4 && main2.f(rn), n4 && main2.f(kn), n4 && main2.f(dn), n4 && main2.f(gn), n4 && main2.f(hn), n4 && main2.f(mn), n4 && main2.f(wn), n4 && main2.f(bn), n4 && main2.f(xn), n4 && main2.f(vn), n4 && main2.f(fn), n4 && main2.f(yn), n4 && main2.f(Hn), n4 && main2.f(Tn), n4 && main2.f(Ln), n4 && main2.f(Mn), n4 && main2.f(Dn), n4 && main2.f(Cn), n4 && main2.f(jn), n4 && main2.f(qn), n4 && main2.f(zn), n4 && main2.f(Nn), n4 && main2.f(Wn), n4 && main2.f(En), n4 && main2.f(Pn), n4 && main2.f(Sn), n4 && main2.f(Gn), n4 && main2.f(Bn), n4 && main2.f(In), n4 && main2.f(An), n4 && main2.f(On), n4 && main2.f(Rn), n4 && main2.f(Fn), n4 && main2.f(Jn), n4 && main2.f(Un), n4 && main2.f($n), n4 && main2.f(Zn), n4 && main2.f(_n), n4 && main2.f(Vn), n4 && main2.f(Yn), n4 && main2.f(Qn), n4 && main2.f(Xn), n4 && main2.f(na), n4 && main2.f(aa), n4 && main2.f(sa), n4 && main2.f(ta), n4 && main2.f(ea), n4 && main2.f(pa), n4 && main2.f(oa), n4 && main2.f(la), n4 && main2.f(ca), n4 && main2.f(ia), n4 && main2.f(ua), n4 && main2.f(ra), n4 && main2.f(ka), n4 && main2.f(da), n4 && main2.f(ga), n4 && main2.f(ha), n4 && main2.f(ma), n4 && main2.f(wa), n4 && main2.f(ba), n4 && main2.f(xa), n4 && main2.f(fa), n4 && main2.f(ya), n4 && main2.f(Ha), n4 && main2.f(Ta), n4 && main2.f(La), n4 && main2.f(Ma), n4 && main2.f(Da), n4 && main2.f(Ca), n4 && main2.f(ja), n4 && main2.f(qa), n4 && main2.f(za), n4 && main2.f(Na), n4 && main2.f(Wa), n4 && main2.f(Ea), n4 && main2.f(Sa), n4 && main2.f(Ga), n4 && main2.f(Ba), n4 && main2.f(Ia), n4 && main2.f(Aa), n4 && main2.f(Oa), n4 && main2.f(Ra), n4 && main2.f(Fa), n4 && main2.f(Ja), n4 && main2.f(Ua), n4 && main2.f($a), n4 && main2.f(Ka), n4 && main2.f(Za), n4 && main2.f(_a), n4 && main2.f(Va), n4 && main2.f(Ya), n4 && main2.f(Qa), n4 && main2.f(Xa), n4 && main2.f(ns), n4 && main2.f(as), n4 && main2.f(ss), n4 && main2.f(ts), n4 && main2.f(es), n4 && main2.f(ps), n4 && main2.f(os), n4 && main2.f(ls), n4 && main2.f(is), n4 && main2.f(us), n4 && main2.f(rs), n4 && main2.f(ks), n4 && main2.f(gs), n4 && main2.f(hs);
      }};
    }
    function v(n3) {
      let a3, s3;
      const r3 = [f2];
      let k2 = {$$slots: {default: [x2]}, $$scope: {ctx: n3}};
      ...
      return a3 = new g({props: k2}), {c() {
        ...
        const t3 = 0 & s4 ? main2.p(r3, [main2.w(f2)]) : {};
